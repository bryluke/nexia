...
import type { PermissionRequestBlock } from "../../../shared/types.ts";
import { summarizeToolInput } from "../../lib/formatters.ts";
  ...
  return (
    <div class={`perm-card perm-${block.status}`}>
      <div class="perm-header">
        ...
        {block.status === "pending" && <span class="perm-spinner" />}
      </div>
      ...
      {block.input != null && (
        <div class="perm-details">
          ...
          >
            <span
              class={`thinking-arrow${inputExpanded ? " expanded" : ""}`}
            >
              &#9654;
            </span>
            Input
